        ...
        <el-table v-loading="listLoading"
            ...
            <el-table-column align="center"
                ...
                <template slot-scope="scope">
                    <span style="color: #1e6abc;cursor: pointer"
                          @click="$router.push({path:'/goods/list',query:{'goodsName':scope.row.goodsName}})">{{scope.row.goodsName}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center"
                             label="商品ID"
            ...
            <el-table-column align="center"
                ...
                <template slot-scope="scope">
                    ...
                    <el-button v-if="scope.row.type === 2"
                               type="info"
                               size="mini">已审批</el-button>
                    <el-button v-if="scope.row.type === 3"
                               type="info"
                               size="mini">审核未通过</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :visible.sync="approveDialogVisible"
            ...
            <div slot="footer"
                ...
                <el-button type="primary"
                           @click="confirmApprove">审批</el-button>
            </div>
        </el-dialog>
    </div>
</template>
